  ...
  return (
    <div style={{ fontFamily: fontStack }}>
      ...
      <div style={{ background: COLORS.bluePale, border: `1px solid ${COLORS.blue}30`, borderRadius: 10, padding: "12px 20px", marginBottom: 16, fontSize: 13, color: COLORS.blue }}>
        ...
        The pipeline (scraper → classifier → text model → ranker) runs externally and produces an output file.
        Connect that output on the <strong>Output UI</strong> page to start reviewing.
      </div>
