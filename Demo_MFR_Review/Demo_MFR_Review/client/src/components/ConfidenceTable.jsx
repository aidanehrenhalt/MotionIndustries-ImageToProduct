        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, fontFamily: fontStack }}>
          <thead>
            <tr style={{ background: COLORS.g50 }}>
              {["Rank", "Image", "AI Confidence", "Text Score", "Final Score", "Source", "Reliability"].map((h) => (
          ...
          <tbody>
            {images.map((img, idx) => (
              ...
              >
                ...
                <td style={{ padding: "10px 14px", fontFamily: monoStack, color: COLORS.g700 }}>{img.finalScore}%</td>
