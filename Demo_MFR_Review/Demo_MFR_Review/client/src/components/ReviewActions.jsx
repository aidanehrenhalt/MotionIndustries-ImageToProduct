...
const REJECT_REASONS = ["Wrong product", "Low quality", "Watermarked", "Competitor logo", "Irrelevant", "Duplicate"];
const ACCEPT_REASONS = ["Exact match", "Close enough", "Best available"];
